...
<div class="p-6">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        ...
        <div>
            <h1 class="font-bold text-red-800">
                <i class="ph ph-scissors"></i> Data Tindakan
            </h1>

            <p class="text-sm text-gray-500">
                Manajemen data tindakan klinik
            </p>
        </div>
    ...
    <form method="GET" class="mb-5">
        ...
        <div class="relative w-full md:w-1/3">
            ...
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama tindakan..."
            ...
            <tbody class="divide-y">
                ...
                <tr class="hover:bg-blue-50/40 transition">
                    ...
                    <td class="px-4 py-3 text-gray-500">
                        {{ ($tindakan->currentPage() - 1) * $tindakan->perPage() + $loop->iteration }}
                    </td>
                    ...
                    <!-- TARIF -->
                    <td class="px-4 py-3 text-gray-600 whitespace-nowrap text-right font-medium">
                        Rp {{ number_format($t->tarif ?? 0, 0, ',', '.') }}
                    </td>
                    ...
                    <td class="px-4 py-3">
                        ...
                        <div class="flex gap-2">
                            ...
                            <!-- EDIT -->
                            <a href="{{ route('tindakan.edit', $t->id) }}"
                            ...
                            <!-- DELETE -->
                            <form id="delete-form-{{ $t->id }}" action="{{ route('tindakan.destroy', $t->id) }}" method="POST">
